...
int main()
{
    ...
    if (file){
        while ((c = fgetc(file)) != EOF){
            ...
            if(!((lowerbound1 < lowerbound2 && lowerbound1 < upperbound2 && upperbound1 < lowerbound2 && upperbound1 < upperbound2) || (lowerbound1 > lowerbound2 && lowerbound1 > upperbound2 && upperbound1 > lowerbound2 && upperbound1 > upperbound2)))
                overlap++;
        }
        if (feof(file))
            fclose(file);
